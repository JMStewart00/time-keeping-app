			...
			<form action="" method="get" class="form-control mx-auto">
				...
				<div class="row w-100 mx-auto">
					...
					<div class="form-group mx-auto col">
						...
						<input type="date" class="form-control" name="task_date" id="task_date" placeholder="YYYY-MM-DD">
					</div>
				</div>
				<div class="row w-100 mx-auto">
					...
					<div class="form-group mx-auto col">
						...
						<input type="time" class="form-control" name="clock_in" id="clock_in" placeholder="00:00">
					</div>
					<div class="form-group mx-auto col">
